...
Each documented plugin gets `docs/plugins/<plugin>/` with the standard page set
(README, design, schemas, evidence) defined in the
[documentation map](../README.md). Create only pages that have real content;
"candidate" and "planned" are prose, not implementation claims.
