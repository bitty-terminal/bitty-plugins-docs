...
> [OQ-021](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) at the design level and partially
> addresses [OQ-022](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) with remaining
...
dependency versions (remaining OQ-021 items now [OQ-026](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) and [OQ-027](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md)); registry service design,
key-directory infrastructure, and revocation details (remaining OQ-022 items
now [OQ-028](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) and [OQ-029](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md));
...
- Per-plugin rollback restores one plugin to its previously retained version;
  targeted disable ([P0-AC-020](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/security/p0-acceptance-criteria.md), risk
...
[OQ-021](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) at the design level; residual items
...
- Migrated to [OQ-026](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) (Dependency resolver
  and constraint grammar): constraint grammar, side-by-side dependency
  versions, and resolver selection semantics.
- Migrated to [OQ-027](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) (Version lifecycle:
...
- Migrated to [OQ-028](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) (Registry service and
...
- Migrated to [OQ-029](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) (Key directory,
