...
> bounded resolutions for [OQ-033](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) (runtime
...
constant; [ADR 0010](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/adrs/ADR-0010-plugin-host-runtime-acceptance.md)
...
- [Security overview](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/security/overview.md): untrusted-by-default posture,
  ...
  (`bitty --safe`).
- [Threat model](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/security/threat-model.md): T-06 (VM escape via
  ...
  and R-016.
- [Core boundaries](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/architecture/core-boundaries.md): mechanism versus
...
[ADR 0003](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/adrs/ADR-0003-core-workspace-topology.md) topology is
unchanged.
...
[OQ-072](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md)). The accepted reload mechanics stay
...
5. Independent review by the category owner, docs curator, and a security
   ...
   [ADR 0010](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/adrs/ADR-0010-plugin-host-runtime-acceptance.md) on
   2026-09-11).
6. Documentation synchronization: this RFC, the
   [open-question register](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md), the
   [decision register](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/index.md), the
   [specifications index](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/specifications/README.md), the
   [Plugin system](../extensibility/plugin-system.md) validation note, and the
   [Core boundaries](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/architecture/core-boundaries.md) pending-decision
...
- [Open-question register](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/open-questions.md) - OQ-033, OQ-034,
  OQ-035 (Accepted); OQ-072 (Open: reload/update triggers and queue drain).
- [Decision register](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/index.md) - candidate queue (accepted
  entry).
- [ADR 0010](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/decisions/adrs/ADR-0010-plugin-host-runtime-acceptance.md) -
...
- [Core boundaries](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/architecture/core-boundaries.md) - ownership, authority,
...
- [Security overview](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/security/overview.md) and
  [Threat model](https://github.com/bitty-terminal/bitty-docs/blob/main/docs/security/threat-model.md) - normative gates.
- [Configuration Model RFC](https://github.com/bitty-terminal/bitty-terminal-docs/blob/main/specifications/configuration-model-rfc.md) - typed settings
