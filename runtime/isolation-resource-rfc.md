...
> [Plugin Platform RFC](../specifications/plugin-platform-rfc.md) (OQ-011/OQ-012/OQ-013,
...
[Plugin Platform RFC](../specifications/plugin-platform-rfc.md)), Plugin API surface (OQ-011,
...
- Given a plugin spawning maximal tasks and timers while flooding its event
  ...
  [Plugin Platform RFC event pipeline](../specifications/plugin-platform-rfc.md#delivery-ordering-batching-and-coalescing)
...
capability RFCs ([Plugin Platform RFC](../specifications/plugin-platform-rfc.md), OQ-011/OQ-012,
2026-08-27).
